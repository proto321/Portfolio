...
`,
  ...
  `,
    ...
    skills: {
      ...
      header: "flex flex-col md:flex-row md:items-end md:justify-between gap-10 mb-16",
      eyebrow: "text-cyan-400 uppercase tracking-[0.3em] text-sm mb-5",
      title: "text-5xl font-bold",
      description: "text-slate-400 max-w-lg leading-8",
      grid: "grid grid-cols-2 md:grid-cols-4 gap-6",
      card:
        "border border-white/10 bg-white/5 rounded-3xl p-8 text-center backdrop-blur-xl hover:bg-cyan-400 hover:text-black hover:shadow-[0_0_30px_rgba(34,211,238,0.4)] hover:-translate-y-1 transition-all duration-300 cursor-pointer",
